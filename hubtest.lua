...
local ToggleCDK = Tabs.Main:AddToggle("ToggleYama", {Title = "Auto Get CDK", Default = false })
           ...
           spawn(function()
            while wait() do
                if _G.AutoCDK then
                    if game:
Players.LocalPlayer.Character:FindFirstChild("Tushita") or game.Players.LocalPlayer.Backpack:FindFirstChild("Tushita") or game.Players.LocalPlayer.Character:FindFirstChild("Yama") or game.Players.LocalPlayer.Backpack:FindFirstChild("Yama") then
            ...
            pcall(function()
                ...
                elseif game:GetService("Workspace").Map:FindFirstChild("HeavenlyDimension") then
                    ...
                    until not Auto_Cursed_Dual_Katana or not Auto_Quest_Tushita_3 or GetMaterial("Alucard Fragment") == 6
                        ...
                        repeat wait(.1)
                            fireclickdetector(game:GetService("Workspace").Map.Waterfall.SealedKatana.Handle.ClickDetector)
                        until game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("CDK") or not _G.AutoCDK
                    end
                end
            end
        end)
